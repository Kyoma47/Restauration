...
*/
	...
	<script type="text/javascript">
		function declancherSubmit(idMenu) {
			console.log("submit");
			setTimeout(function () {
				document.getElementById("form-"+idMenu).submit()
			}, 2000);
		}
	</script>
</head>
...
<body>
	<%
		...
		sub afficher()
			Response.write("<ul style='background-color: fireBrick; color:ivory;'>")
				i=0
				while not isEmpty(panier(i,0))
					Response.write("<li> (" & panier(i,0) & " , " & panier(i,1) & ")</li>")
					i = i+1
				wend
			Response.write("</ul>")
		end sub
						...
						<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item ombre">
							<figure style="width: 250px; height:30em; margin-top:20px;">
								...
								<figcaption style="height:250px;">
									...
									<a href="#myModal-<%=RsMenu("IdMenu")%>" class="tm-btn tm-btn-success tm-right trigger-btn" data-toggle="modal"
									 onclick="declancherSubmit(<%=RsMenu("IdMenu")%>)" style="padding:9px; float:right;">
								...
								<div id="myModal-<%=RsMenu("IdMenu")%>" class="modal fade">
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item ombre">
						<figure style="width: 250px; height:30em; margin-top:20px;">
							...
							<figcaption style="height:250px;">
								...
								<a href="#myModal-<%=RsPlat("IdMenu")%>" class="tm-btn tm-btn-success tm-right trigger-btn" data-toggle="modal"
									 onclick="declancherSubmit(<%=RsPlat("IdMenu")%>)" style="padding:9px; float:right;">
									<i class="fa fa-shopping-cart" aria-hidden="true"></i> &nbsp; Commander
								</a>
							...
							<div id="myModal-<%=RsPlat("IdMenu")%>" class="modal fade">
								<div class="modal-dialog modal-confirm">
									<div class="modal-content">
										<div class="modal-header justify-content-center">
											<div class="icon-box">
