...
IF NOT EXISTS( SELECT * FROM sys.all_columns WHERE Name = N'Image' and Object_ID = Object_ID(N'TMENUS') )
ALTER TABLE TPLATS ADD Image VARCHAR(30) SELECT * FROM TMENUS ;
GO
